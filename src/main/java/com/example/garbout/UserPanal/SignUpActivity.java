...
public class SignUpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        user_CNIC = findViewById(R.id.userConfirmPassword);
        ...
        registerBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final String user_CNIC = user_password.getEditText().getText().toString();
...
//                                    checkUser();
    ...
    private Boolean validatePhoneNo() {
        ...
        if (val == null || val.length() < 11 || val.length() > 13) {
            return false;
        }
        else {
            Toast.makeText(this, "please insert correct or complete  phone number   ", Toast.LENGTH_SHORT).show();
        }
        if (val.isEmpty()) {
    ...
    private Boolean validateCNIC() {
        String val = user_CNIC.getEditText().getText().toString();

        if (val == null || val.length() < 15 || val.length() > 13) {
            return false;
        }
        else {
            Toast.makeText(this, "please insert complete CNIC with dash ", Toast.LENGTH_SHORT).show();
        }
//        else {
//            return android.util.Patterns.PHONE.matcher(target).matches();
//        }
        if (val.isEmpty()) {
            user_CNIC.setError("Field cannot be empty");
            return false;
        } else {
          user_CNIC.setError(null);
            user_CNIC.setErrorEnabled(false);
            return true;
        }
    }
